...
function GetInvolved() {
  return (
    <section className="p-24">
      ...
      <h2 className="text-center text-4xl font-extrabold leading-loose pt-4">
        هدف ما فراهم نمودن دسترسی آسان به کارآفرینی و سرمایه‌گذاری در ایده‌های
        خلاقانه برای همه است
      </h2>
      <h3 className="text-center text-2xl text-primary mt-4">
        شما هم می‌توانید در این راه با ما همراه شوید
      </h3>

      <div className="flex justify-center w-full h-[25rem] gap-3 mt-8">
        <div className="w-1/3 border-2 border-slate-500 text-slate-500 rounded-lg flex flex-col items-center gap-8 p-8 group hover:border-white hover:border-4 hover:text-white">
