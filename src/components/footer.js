    ...
    <footer className="w-full h-18 px-12 md:px-24 md:py-8 bg-primary text-black flex items-end justify-between">
      ...
      <div className="flex flex-col items-end gap-8">
        <div className="md:flex gap-4 hidden">
            <a href="https://www.linkedin.com/company/infinity-lab-startup-studio/" target="_blank"><img src={linkedinIcon} alt="linkedin" height={30}  /></a>
            <a href="https://www.instagram.com/infinitylab.studio/" target="_blank"><img src={instagramIcon} alt="instagram" height={30} /></a>
            <a href="https://t.me/infinitylabstudio" target="_blank"><img src={telegramIcon} alt="telegram" height={30} /></a>
        </div>
